...
const Banner = () => {
  ...
  const carouselData = [
    {
      ...
      description: "Solusi terbaik untuk segala kebutuhan elektronik Anda di Jakarta Barat."
    },
    {
      image: "/images/Banner/banner-image-2.png",
      title: "Layanan Antar-Jemput Barang",
      description: "Gratis antar-jemput untuk servis di wilayah Jakarta Barat dan sekitarnya."
    },
    {
      image: "/images/Banner/banner-image-3.png",
      title: "Perbaikan di Lokasi Anda",
      description: "Nikmati kemudahan layanan perbaikan langsung di lokasi Anda."
    },
    {
      image: "/images/Banner/banner-image-4.png",
      title: "Promo dan Diskon Menarik",
      description: "Manfaatkan berbagai promo untuk perbaikan elektronik Anda."
    },
  ];
  ...
  return (
    <>
      <Head>
        <title>AIS Elektronik - Jasa Service Elektronik Terpercaya</title>
        <meta
          name="description"
          content="AIS Elektronik adalah penyedia jasa servis elektronik terpercaya di Jakarta Barat. Kami melayani perbaikan elektronik rumah tangga dan kantor."
        />
      </Head>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center min-h-[600px]">
            ...
            <div className="col-span-6 flex flex-col justify-center h-full">
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-6 text-black lg:text-start text-center">
                Solusi Terbaik <br /> untuk Perbaikan Elektronik Anda di Jakarta Barat
              </h1>
