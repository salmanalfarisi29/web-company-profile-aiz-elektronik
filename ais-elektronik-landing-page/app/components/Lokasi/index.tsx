...
const Location = () => {
  return (
    <>
      <Head>
        <title>Lokasi Ais Elektronik - Service Elektronik Jakarta Barat</title>
        <meta
          name="description"
          content="Temukan lokasi Ais Elektronik di Srengseng, Jakarta Barat. Kami melayani service elektronik rumah tangga dan kantor dengan teknisi berpengalaman."
        />
      </Head>
      <div id="lokasi" className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6">
          {/* Heading */}
          <div className="text-center mb-12">
            <Fade direction="up" triggerOnce>
              <h1 className="text-[#1B71A1] text-lg font-normal mb-3 tracking-widest uppercase">
                Lokasi Kami
              </h1>
            </Fade>
